...
METHOD_SPEC = {
    "algorithm_id": "P046-Goldstein-Optimization",
    "algorithm_name": "GoldsteinSparseOptimizationBenchmarkMatrix",
    ...
    "decision_rule": "Rank seed cases by trustworthy-specific priority score with Goldstein-aligned focus term 'optimization'.",
