...
EvidenceLoop Research Agent: optimization for Goldstein-Aligned Research

## Motivation

This project targets the intersection of **ML + optimization, adversarial robustness, LLMs, data** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to Tom Goldstein's research area.
...
Advisor-specific slice: **ML + optimization, adversarial robustness, LLMs, data**.
