...
This project targets **ML + optimization, adversarial robustness, LLMs, data** with a concrete, reproducible artifact rather than a vague expression of interest. The goal is to show research taste, useful engineering, and honesty about what has and has not been completed.
